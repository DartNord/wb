        ...
        <div className="call-us-form">
            <div className="call-us-image">
                <form id="send_form">
                    ...
                    <input type="hidden" name="admin_email" value="master-zayav@yandex.ru"/>
                    ...
                    <h5>Ваше имя</h5>
                    <input id="name" type="text" placeholder="Введите имя:" maxlength="10" name="Имя заказчика" required minLength="3"/>
